...
class Slides {
  constructor(data) {
    ...
    this.slides = this.data.map((entry, index) => {
      ...
      const quotel1 = createEleWithClass("p", "slide-meta");
      const quotel2 = createEleWithClass("p", "slide-meta");
      ...
      quotel1.innerHTML = entry.quotel1;
      quotel2.innerHTML = entry.quotel2;

      more.innerHTML = entry.moretext;
      ...
      slide.appendChild(quotel1);
      slide.appendChild(quotel2);
